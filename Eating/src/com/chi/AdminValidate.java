...
/**
 * Servlet Filter implementation class AdminValidate
 */
@WebFilter("/AdminValidate")
public class AdminValidate implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if(currentuser == null||currentuser == ""||currentuser.equals("")){
        	if(!(url.contains("login")||url.contains("Login")))
        	{
        		String path = "/Eating/admin/login.jsp";
