...
<html>
	...
	<body>
		...
		<div id="main">
			...
			<div class="b02">
				<div class="b02-2" style="background-color:#FFFFFF"> 
					<p class="b02-3" style="height:40px;line-height:40px;background-color:#f4f4f4;font-size:18px;padding-left:10px;">
						我的订单/详细信息
					</p>
					<%for (Map<String, Object> m : tbid) { %>
					<div class="b02-4" style="background-color:#FFFFFF;">
						<p style="padding-left:10px;"><%=m.get("cainame") %>:<span style="color:#3091f2"><%=m.get("count") %>份</span></p>
					</div>
					<% } %>
					总价<span style="color:#3091f2"><%=tc.get("sumprice") %></span>元。
				</div>
			</div>
